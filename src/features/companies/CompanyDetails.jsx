...
import profile from "../../assets/images/companyLogo.svg";
  ...
  return (
    <div
      className={`${
        selectedId === null
          ? "hidden"
          : "relative rounded-[20px] bg-white p-[24px_24px_30px] "
    ...
    >
      <div className="basis-full">
        ...
        <div>
          ...
          bg-white p-[14px_130px] text-lg font-semibold text-primary transition-all duration-200 hover:bg-primary hover:text-white"
          >
            + Follow
          </button>
        </div>
      ...
      <div className="basis-full ">
        <div className="flex flex-col gap-[26px]">
          <h5 className="text-base font-semibold">About Company</h5>
          <div className="flex flex-col gap-[18px]">
            <span className="text-sm text-[#313131]">{company.about}</span>
            <span className="text-sm text-[#313131]">{company.about}</span>
          </div>
        </div>
        <div className="mt-9 flex gap-5">
          <button className="rounded-[70px] bg-primary p-[14px_26px] text-lg font-semibold text-white transition-all duration-200 hover:bg-gray-100 hover:text-gray-300">
            {company.vacancies?.length} Vacancy
          </button>
          <button className="rounded-[70px] bg-gray-100 p-[14px_26px] text-lg font-semibold text-gray-300 transition-all duration-200 hover:bg-primary hover:text-white">
            More Detail
          </button>
        </div>
      </div>
