...
function ProfileUser() {
  return (
    <div className="relative flex flex-1 flex-col rounded-[20px] bg-card md:p-[36px_30px_40px] p-5 sm:flex-row sm:gap-2 md:flex-col md:gap-0">
      <div className="sm:flex-1 sm:p-3 md:flex-auto md:p-0">
        <div className="flex flex-col items-center sm:mb-6 md:mb-0">
          ...
          <div>
            ...
            <span className="text-base leading-6 text-gray-900 dark:text-gray-200   ">
              Programmer
            </span>
          </div>
        </div>
        <div className="mt-[30px] flex items-center justify-center gap-[22px]">
          <div className="max-w-[200px] flex-1 rounded-[20px] border border-solid border-gray-100 px-7 py-3 text-center">
            <p className="text-2xl font-semibold dark:text-gray-200">228</p>
            <span className="text-base dark:text-gray-300">Following</span>
          </div>
          <div className="max-w-[200px] flex-1 rounded-[20px] border border-solid border-gray-100 px-7 py-3 text-center">
            <p className="text-2xl font-semibold dark:text-gray-200">4842</p>
            <span className="text-base dark:text-gray-300">Followers</span>
          </div>
        </div>
      </div>
      ...
      <div className="sm:flex-1 sm:p-3 md:flex-auto md:p-0">
        <div className="flex flex-col gap-5">
          <div className=" flex items-center gap-5">
            ...
            <a href="tel:+50 123 456 78" className="text-base dark:text-gray-200">
              +50 123 456 78
            </a>
          </div>
          <div className=" flex items-center gap-5">
            ...
            <a href="mailto:davidheree@mail.com" className="text-base dark:text-gray-200">
              davidheree@mail.com
            </a>
          </div>
        </div>
